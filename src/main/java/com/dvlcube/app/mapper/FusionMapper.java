...
public class FusionMapper implements GenericMapper<Fusion, FusionDTO>, FilterMapper<Fusion, FusionDTO> {
    @Override
    public Fusion convertFilterToEntity(FusionDTO filterDTO) {
